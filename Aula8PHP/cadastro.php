...
<body class="d-flex align-items-center py-4 bg-body-tertiary cadastro">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="auxcadastro.php" method="POST">
            <h1 class="h3 mb-3 fw-normal"> <?= isset($id_alterar) ? 'Alterar Dados' : 'Dados de Cadastro' ?></h1>
            ...
            <input class="btn btn-primary w-100 py-2 mt-5" type="submit" value="<?= isset($id_alterar) ? 'Altera' : 'Cadastrar' ?>">
