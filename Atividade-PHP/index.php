...
<table>
    ...
    $dados = [
        ...
        ["ID" => 15, "Modelo" => "Corolla", "Cor" => "Branco", "Placa" => "DEF-5678", "Ano" => 2020, "Marca" => "Toyota", "Quantidade_de_portas" => 4, "Tipo" =>"Automóvel"],
        ["ID" => 16, "Modelo" => "Corolla", "Cor" => "Branco", "Placa" => "DEF-5678", "Ano" => 2020, "Marca" => "Toyota", "Quantidade_de_portas" => 4, "Tipo" =>"Automóvel"],
        ["ID" => 17, "Modelo" => "Corolla", "Cor" => "Branco", "Placa" => "DEF-5678", "Ano" => 2020, "Marca" => "Toyota", "Quantidade_de_portas" => 4, "Tipo" =>"Automóvel"],
        ["ID" => 18, "Modelo" => "Corolla", "Cor" => "Branco", "Placa" => "DEF-5678", "Ano" => 2020, "Marca" => "Toyota", "Quantidade_de_portas" => 4, "Tipo" =>"Automóvel"],
        ["ID" => 19, "Modelo" => "Corolla", "Cor" => "Branco", "Placa" => "DEF-5678", "Ano" => 2020, "Marca" => "Toyota", "Quantidade_de_portas" => 4, "Tipo" =>"Automóvel"],
        ["ID" => 20, "Modelo" => "Corolla", "Cor" => "Branco", "Placa" => "DEF-5678", "Ano" => 2020, "Marca" => "Toyota", "Quantidade_de_portas" => 4, "Tipo" =>"Automóvel"]
    ];
